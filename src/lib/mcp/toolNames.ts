...
export const WRITE_TOOL_NAMES = ["crm_log_interaction", "crm_update_lead", "crm_draft_email", "crm_send_email", "crm_list_drafts", "crm_create_lead", "crm_delete_lead", "crm_restore_lead"] as const;
