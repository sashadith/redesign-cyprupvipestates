...
You'll receive a compact JSON data payload (GSC 28-day period-over-period stats per locale, click winners/losers, the CTR watchlist, a striking-distance list, Core Web Vitals status per template class, platform/publishing stats, title-sweep status, and a site changelog of recent structural changes). Analyze it and produce AT MOST 5 suggestions — quality over quantity; if the data doesn't support 5 good ideas, return fewer.
