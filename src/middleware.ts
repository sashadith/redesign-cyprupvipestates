...
// Moved to their own module 2026-08-11 so src/app/sitemaps/[type]/route.ts's
// blog/pages generators can skip these same URLs instead of keeping a second,
// driftable copy of the list — see legacyRedirectMaps.ts's own header comment.
