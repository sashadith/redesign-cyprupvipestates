...
/* Legal documents (Privacy & Terms) — redesigned. Isolated route tree, same as preview-partners /
   ...
   middleware.ts rewrites the real /privacy-policy, /de/datenschutzrichtlinie,
   /warunki, /uslovija-i-polozhenija and their siblings onto it, so
   "preview-legal" is never a URL a visitor sees.
