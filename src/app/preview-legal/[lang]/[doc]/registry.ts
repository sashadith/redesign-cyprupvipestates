...
const DOCS: Record<LegalDocKey, Record<string, LegalDoc>> = {
  privacy: { en: PRIVACY_EN, de: PRIVACY_DE, pl: PRIVACY_PL, ru: PRIVACY_RU, he: PRIVACY_HE },
  terms: { en: TERMS_EN, de: TERMS_DE, pl: TERMS_PL, ru: TERMS_RU, he: TERMS_HE },
};
