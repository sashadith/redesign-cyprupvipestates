...
export default function DescriptionField({ developmentId, initial, aiReady }: { developmentId: string; initial: Record<Lang, string>; aiReady: boolean }) {
  ...
  return (
    <div className="space-y-2" ref={rootRef}>
      ...
      <p className="text-[11px] text-[#9CA3AF]">Rewrite is name-free and synthesises location, amenities and unit data across {`all ${LANGS.length} languages`}. External AI-content detection (Originality.ai) plugs in once its key is set.</p>
    </div>
  );
}
