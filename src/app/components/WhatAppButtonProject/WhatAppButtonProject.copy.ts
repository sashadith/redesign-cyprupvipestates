// Sibling copy module for WhatAppButtonProject.tsx — moved out of the
// component (Hebrew Localization Phase 4, controller amendment 2). `messages`
// and `messageWithUrl` were already widened to `Record<Locale,…>` with a `he`
...
export const messageWithUrl: Record<Locale, string> = {
  ...
  he: `${messages.he}\n\nI'm sending this message from the page:`, // TODO(he)
};

export const label: Record<Locale, string> = {
  en: "Message us on WhatsApp",
  de: "Schreiben Sie uns auf WhatsApp",
  pl: "Napisz do nas na WhatsAppie",
  ru: "Написать в WhatsApp",
  he: "Message us on WhatsApp", // TODO(he)
};
