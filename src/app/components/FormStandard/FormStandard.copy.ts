// Sibling copy module for FormStandard.tsx — lifted from
...
export const FORM_STANDARD_COPY: Record<Locale, typeof FORM_STANDARD_EN> = {
  en: FORM_STANDARD_EN,
  de: {
  ...
  he: FORM_STANDARD_EN, // TODO(he)
};

export const formStandardCopy = (lang: string) =>
  FORM_STANDARD_COPY[isLocale(lang) ? lang : "en"];
