...
export const FAQ_COPY: Record<Locale, FaqCopy> = {
  ...
  he: {
    metaTitle: "שאלות נפוצות על קניית נכס בקפריסין | Cyprus VIP Estates",
    metaDescription:
      "מה שרוכשים מישראל הכי רוצים לדעת לפני קניית נכס בקפריסין: זכאות לזרים, עלויות ומע\"מ, תושבות קבע, מימון ופרויקטים חדשים.",
    eyebrow: "תמיכה",
    heroTitlePart1: "שאלות נפוצות על ",
    heroTitlePart2: "",
    heroTitlePart3Italic: "קניית נכס בקפריסין",
    heroLead: "תשובות ישירות למה שרוכשים מישראל הכי רוצים לדעת לפני קניית נכס בקפריסין, במהלכה ואחריה.",
    heroMeta: (q, t) => `${q} שאלות ב-${t} נושאים`,
    allChipLabel: "הכל",
    questionsCount: (n) => (n === 1 ? "שאלה אחת" : `${n} שאלות`),
    expandAll: "פתיחת הכל",
    collapseAll: "סגירת הכל",
    categoriesAriaLabel: "קטגוריות שאלות נפוצות",
    formTitlePlain: "נשארה לכם ",
