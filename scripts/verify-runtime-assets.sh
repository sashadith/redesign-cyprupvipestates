...
REQUIRED_FILES=(
  ...
  # src/app/[lang]/page.tsx's homepage og:image) — a committed static file,
  # not generated by `next build`, so a broken/missing checkout would silently
  # 404 every og:image/twitter:image tag sitewide.
  "public/og/home-1200x630.jpg"
)
